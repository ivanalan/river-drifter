...
void initPlayer()
{
    ...
    shadowOAM[0].attr2 = ((player.aniState)*32 + (player.id));
}
...
void updateTimeline()
{
    ...
    shadowOAM[3].attr1 = (65 + (player.distanceTraveled / speed)) | (0 << 14);
    if (cheat)
    {
        shadowOAM[3].attr2 = ((0)*32 + (20));
    }
    else
    {
        shadowOAM[3].attr2 = ((0)*32 + (player.id));
    }

    int interval = 70;

    shadowOAM[10].attr0 = 15 | (0 << 14);
...
void updatePlayer()
{
    ...
    if (cheat == 1)
    {
        shadowOAM[0].attr2 = ((player.aniState)*32 + (20));
    }
    else
    {
        shadowOAM[0].attr2 = ((player.aniState)*32 + (player.id));
